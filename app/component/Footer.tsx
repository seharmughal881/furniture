...
// export function Footer() {
//   return (
//     <div style={{ fontFamily: "'Arial', 'Helvetica Neue', Helvetica, sans-serif", fontSize: "13px", color: "#1a1a1a", backgroundColor: "#f2ede7" }}>
...
//         {/* Have questions? panel - Full width on mobile */}
//         <div style={{ 
//           width: "100%",
//           flexBasis: "100%",
//           marginTop: "20px",
...
//       }}>
//         {/* Social icons */}
//         <div style={{ display: "flex", gap: "12px", alignItems: "center", order: window.innerWidth < 768 ? 2 : 1 }}>
//           {/* Facebook */}
//           <a href="#" style={{ color: "#1a1a1a", display: "flex" }}>
//             <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: "18px", height: "18px" }}>
//               <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
...
//           alignItems: "center",
//           flexWrap: "wrap",
//           order: window.innerWidth < 768 ? 4 : 4
//         }}>
//           {/* VISA */}
//           <div style={{ background: "#1a1f71", borderRadius: "4px", padding: "3px 7px", height: "24px", display: "flex", alignItems: "center" }}>
//             <span style={{ color: "#fff", fontWeight: "900", fontSize: "11px", fontStyle: "italic", letterSpacing: "0.5px" }}>VISA</span>
...
//         backgroundColor: "#fff",
//         borderTop: "1px solid #e0d9d0",
//         padding: window.innerWidth < 768 ? "10px 20px" : "10px 40px",
//         display: "flex",
//         flexDirection: window.innerWidth < 768 ? "column" : "row",
//         alignItems: "center",
//         justifyContent: "space-between",
...
//             fontWeight: "500", 
//             color: "#1a1a1a" 
//           }}>Kingsdown Studio Cares...</span>
//           {/* Stars */}
//           <span style={{ display: "flex", alignItems: "center", gap: "2px" }}>
//             {[1, 2, 3, 4].map(i => (
//               <svg key={i} viewBox="0 0 24 24" style={{ width: window.innerWidth < 768 ? "14px" : "16px", height: window.innerWidth < 768 ? "14px" : "16px" }} fill="#f5a623">
//                 <polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26" />
//               </svg>
//             ))}
//             {/* Half star */}
//             <svg viewBox="0 0 24 24" style={{ width: window.innerWidth < 768 ? "14px" : "16px", height: window.innerWidth < 768 ? "14px" : "16px" }}>
//               <defs>
//                 <linearGradient id="half">
//                   <stop offset="50%" stopColor="#f5a623" />
//                   <stop offset="50%" stopColor="#d8d0c6" />
...
//             color: "#1a1a1a",
//             borderRadius: "4px",
//             padding: window.innerWidth < 768 ? "12px 20px" : "10px 30px",
//             fontSize: window.innerWidth < 768 ? "13px" : "14px",
//             fontWeight: "500",
//             cursor: "pointer",
//             display: "flex",
